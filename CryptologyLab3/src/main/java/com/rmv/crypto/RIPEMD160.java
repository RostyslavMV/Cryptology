...
public class RIPEMD160 {
    ...
    private static final int st_h0 = 0x67452301;
    private static final int st_h1 = 0xEFCDAB89;
    private static final int st_h2 = 0x98BADCFE;
    private static final int st_h3 = 0x10325476;
    private static final int st_h4 = 0xC3D2E1F0;
    ...
    public static String countHash(String data) {
        ...
        byte[] newBytes;
        if (mod_val > 56) {
            newBytes = new byte[bytes.length + 64 - mod_val + 64];
        }
        else {
            newBytes = new byte[bytes.length + 64 - mod_val];
        }
        ...
        for (byte re : res) {
            if (re > 0 && re <= 15)
                ans.append("0").append(Integer.toHexString(re & 0xFF));
            else if (re == 0)
                ans.append("00");
            else
                ans.append(Integer.toHexString(re & 0xFF));
        }
